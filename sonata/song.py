...
_SongRecord = namedtuple('SongRecord',
                        ['album', 'artist', 'albumartist', 'genre', 'year', 'path'])

def SongRecord(album=None, artist=None, albumartist=None, genre=None, year=None, path=None):
    return _SongRecord(album, artist, albumartist, genre, year, path)
